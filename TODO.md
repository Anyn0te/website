...
### Version 0.7.0 - Multiple Media Uploads and Bug Fixes
...
### Version 0.8.0 - Mobile Navigation Improvements
...
### Version 0.9.0 - Create Note Modal and UI Enhancements
...
### Version 0.10.0 - Modular Architecture and Storage Refactor
...
### Version 0.11.0 - Engagement, Persistence, and Core Features

| Type             | Description                                                                                                                                  |
| :--------------- | :------------------------------------------------------------------------------------------------------------------------------------------- |
| **Persistence**  | **Database Migration:** Finalized initial steps for migration to a proper database system.                                                   |
| **Feature**      | **Note Editor:** Initial implementation of a dedicated Note Editor for post management.                                                      |
| **Feature**      | **Flexible Posting:** Enabled users to post a note even if only one field (Title or Content) is filled.                                      |
| **Feature**      | **Dynamic Media Serving:** Implemented dynamic serving mechanisms for uploaded media files.                                                  |
| **Feature**      | **Revamped Audio Player:** Added a new, revamped audio player component to handle audio files attached to notes.                             |
| **Feature**      | **New Pages/Sections:** Added dedicated routes for `/about`, `/notes`, and `/minotes` sections.                                              |
| **Feature**      | **Dashboard My Notes:** Implemented logic to show logged-in users their own notes within the Dashboard section.                              |
| **Feature**      | **Comment/PM System:** Added a private comment feature with encryption, resembling a personal message (PM) system.                           |
| **Feature**      | **Reaction System:** Implemented a system for users to react to notes.                                                                       |
| **Feature**      | **Notification System:** Added the core notification system and reworked its pulling/display logic.                                          |
| **Feature**      | **Post Reach Logic:** Reworked post engagement and reach mechanics, including time-based post reach and reaction/engagement-based promotion. |
| **Feature**      | **Sorting:** Introduced a new post sorting style mechanism.                                                                                  |
| **Feature**      | **Theming/UI:** Added animations, reworked card sizing, and fixed various CSS issues and theming glitches.                                   |
| **Feature**      | **Config:** Added the ability to run the application over a specific port using a `.env` file.                                               |
| **Fix/Refactor** | Implemented general improvements and under-the-hood optimization for performance.                                                            |
| **Fix**          | Fixed alignment issues for icons.                                                                                                            |
| **Fix**          | Resolved a bug related to displaying "My Notes."                                                                                             |
| **Fix**          | Fixed the `following` mechanism.                                                                                                             |
| **Fix**          | Applied fixes to media handling and limitations.                                                                                             |
| **Fix**          | Resolved issues with push notifications.                                                                                                     |
| **Security**     | Added permission checks for moderation features.                                                                                             |
